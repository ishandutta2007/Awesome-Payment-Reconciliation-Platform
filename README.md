...
- **[Numeric](https://www.numeric.io/)**  
  AI-powered financial close and real-time account/cash reconciliation platform with deep ERP integrations and high auto-match rates.

- **[BlackLine](https://www.blackline.com/)**  
  Enterprise-grade cloud platform for account reconciliation, transaction matching, journal entry automation, and financial close management.

- **[ReconArt](https://www.reconart.com/)**  
  Configurable web-based reconciliation and financial close platform supporting high-volume multi-way matching, exception management, and balance sheet certification.

- **[Trintech Adra](https://www.trintech.com/adra/)**  
  Mid-market financial close suite with multi-way transaction matching, balance sheet reconciliations, task management, and journal entry automation.

- **[Fiserv Frontier Reconciliation](https://www.fiserv.com/)**  
  Enterprise end-to-end reconciliation and certification solution for high-volume bank, payment, and inter-system matching with strong audit controls (now under Trintech).

- **[AutoRek](https://www.autorek.com/)**  
  No-code, AI-enhanced reconciliation and financial control platform for banks, payments, insurance, and asset management with regulatory rulebooks.

- **[SmartStream TLM](https://www.smartstream-stp.com/)**  
  Transaction Lifecycle Management reconciliation platform specializing in high-volume trade, cash, and collateral matching for capital markets and banks.

- **[Duco](https://www.du.co/)**  
  Cloud-native data reconciliation and automation platform focused on complex, high-volume matching and exception handling in financial services.

- **[SolveXia](https://www.solvexia.com/)**  
  No-code automation platform for multi-source data reconciliation, variance analysis, and workflow-driven financial processes.

- **[OneStream](https://www.onestream.com/)**  
  Unified corporate performance management platform with embedded account reconciliation, consolidation, and close automation capabilities.
